...
<div class="container">
    <nav class="navbar navbar-dark bg-primary">
        <a class="navbar-brand" href="/">数据采集平台</a>
        <ul class="nav navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                   aria-expanded="false">普通网页抓取</a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/panel/commons/list">搜索</a>
                    <a class="dropdown-item" href="/panel/commons/domainList">网站列表</a>
                    <a class="dropdown-item" href="/panel/commons/tasks">查看进度</a>
                    <a class="dropdown-item"
                       href="/panel/commons/editSpiderInfo">编辑模板</a>
                    <a class="dropdown-item"
                       href="/panel/commons/listSpiderInfo">模板列表</a>
                    <a class="dropdown-item"
                       href="/panel/commons/updateBySpiderInfoID">更新数据</a>
                    <a class="dropdown-item"
                       href="/panel/commons/listQuartz">定时任务管理</a>
                </div>
            </li>
        </ul>
    </nav>
